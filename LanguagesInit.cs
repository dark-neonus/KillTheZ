    ...
    public class GameLanguages
    {
        public static void Init()
        {
            ...
            GameData.aplication.gameText.AddSomeText(new Dictionary<string, Dictionary<string, string>>()
            {
                ...
                {"Tut2_15", new Dictionary<string, string>() { { GameData.english.name, "Press E to plant mine" }, { GameData.ukraine.name, "Нажміть E(Укр.У) щоб встановити міну" }, { GameData.polish.name, "Naciśnij E, aby umieścić mój" } } },
                ...
                {"Tut4_7", new Dictionary<string, string>() { { GameData.english.name, "They can't do anything advanced for Ukrainian vehicles," }, { GameData.ukraine.name, "Вони не можуть зашкодити просунутій українській техніці," }, { GameData.polish.name, "Nie mogą zaszkodzić zaawansowanej ukraińskiej technologii," } } },
